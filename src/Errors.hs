...
throwBenedictError ExistingDictionary    = lift $ throwE $ err409 { errBody = "Dictionary already exists." }
throwBenedictError NonExistingDictionary = lift $ throwE $ err404 { errBody = "Dicionary does not exist" }
